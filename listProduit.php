...
?>
  ...
  <tbody>
    ...
    <td> <img src=<?php echo "imageProd/".$tableau[2]; ?> alt="rien" width="40" height="40" style="border-radius:80px;"/> </td>
    <td>
		<a href="listProduit.php?idProd=<?php echo $donne['id']?>"> <button class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette entrée ?')">Delete</button> </a>
      </td> 
  </tr>
