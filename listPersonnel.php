...
$conn = mysqli_connect("localhost", "root", "", "ingenuis");
$statut =0;

$identifiant = isset($_GET['idClasse'])? $_GET['idClasse']:"";

if($identifiant !=""){
$sql = "SELECT * FROM equipe WHERE id = $identifiant";
...
if($identifiant !=""){
    $req = $db->prepare('UPDATE equipe SET statut = :valeur WHERE id = :identifiant');
    ...
    function changeColor() {
        ...
        button.innerHTML = 'Desactiver';
    }
</script>";
    echo "<script type='text/javascript'> alert('Changement de statut avec succes');</script>";
...
<h3 class="mb-0">Liste Des Membre De L'equipe</h3>
<p>consulter la liste des membres de votre équipe.</p>
...
<table class="table lms_table_active2  table-bordered  table-striped  ">
<thead>
<tr>
<th scope="col">Numero</th>
<th scope="col">Nom personnel</th>
<th scope="col">Numero personnel</th>
...
<td><?php echo $donne['nomUser']?></td>
<td><?php echo $donne['phone']?></td>
<td><?php echo $donne['role']?></td>
<td> <img src=<?php echo "ImageProfil/".$donne['imageProfil']; ?> alt="rien" width="50" height="50" style="border-radius:80px;"/> </td>
<td> <a href="listPersonnel.php?idClasse=<?php echo $donne['id']?>"><button id="myButton" class="btn btn-success" onclick="changeColor()"> Activer</button> </a></td>
</tr>
</tbody>
