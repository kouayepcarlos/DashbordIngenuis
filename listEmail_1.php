...
$requete = "SELECT * FROM adresse_client";
...
<h3 class="mb-0">Liste Des Emails</h3>
<p>consulter les emails des personnes souhaitant connaitre les periodes de promotion sur les prix.</p>
...
<table class="table table-striped table-bordered">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Ecrire à l'adresse client</th>
    </tr>
  </thead>
  <?php
  $i =1;
...
?>
  ...
  <tbody>
    <tr>
      ...
      <td><?php echo $donne['emailAdresse']?></td>
      <td> <a href="https://accounts.google.com/v3/signin/identifier?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&emr=1&ifkv=AYZoVhccZuxb8zr_2gbg8JfWaiGeT3MKxtv1v79E4UHwGB3_RTnj1Cp3HueHvwS_IO8olMICNdgm7Q&ltmpl=default&ltmplcache=2&osid=1&passive=true&rm=false&scc=1&service=mail&ss=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin&dsh=S-1409203240%3A1696664755631921&theme=glif"> <button class="btn btn-success"> Message </button> </a> </td>
    </tr>
