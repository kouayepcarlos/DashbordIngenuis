...
<h3 class="mb-0">Liste Des Consultations</h3>
<p>consulter les differentes Consultations prise sur le site.</p>
...
<table class="table table-striped table-bordered">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Diplôme Scolaire</th>
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $donne['quartier']?></td>
      <td><?php echo $donne['dateContact']?></td>
      <td><?php echo $donne['diplome']?></td>
      <td><?php echo $donne['domaine']?></td>
    </tr>
